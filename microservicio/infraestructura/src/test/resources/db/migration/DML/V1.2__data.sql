...
insert into cita(id, codigo_mascota, id_veterinario, codigo_servicio, total_pago, fecha) values(2, 2, 1, 1, 130000, now());
insert into cita(id, codigo_mascota, id_veterinario, codigo_servicio, total_pago, fecha) values(3, 2, 1, 1, 130000, now());
insert into cita(id, codigo_mascota, id_veterinario, codigo_servicio, total_pago, fecha) values(4, 2, 1, 1, 130000, now());