...
public class ServicioCrearCitaTest {
    ...
    void deberiaRealizarDescuentoPorCumpleaniosDeLaMascota() {
        ...
        DtoMascota dtoMascota = new DtoMascota(1L, "1234", "Titan", "Husky", LocalDate.of(2022, 05, 12), 30);
        Cita citaRespuesta = new Cita(1L, 1L, 1L,1L, 171000, LocalDate.of(2022, 05, 12));
